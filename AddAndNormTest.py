...
residual_tensor = np.array([[1.0, 2.0, 3.0], [5.0, 5.0,5.0], [5.0, 5.0,5.0]])  # Oryginalne wejście
attention_output = np.array([[0.5, -1.0, 1.5], [1.0, 1.0,2.0], [5.0, 5.0,5.0]])  # Wynik z warstwy uwagi
